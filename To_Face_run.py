...
def test(model, test_dataset):
    ...
    with torch.no_grad():
        for i, (orientation,depth, tof_data) in enumerate(test_dataset):
            ...
            out_orientation, out_depth, upsampled = model(tof_data)
            # print(targets)
            ...
            upsampled_sum = upsampled.view(-1,18,20,8,8).sum(dim = 2)
...
def train(data_path, modelname):
    ...
    save_path = 'weights/'+ log_name +model_name+'1_1_1_-3_norelu_swt.pth'
...
if __name__ == '__main__':
    #python To_Face_run.py --data_folder inves_dataset/dataset_facial1/  
